    ...
    override fun onStart() {
        ...
        binding.apply {
            ...
            if(string.equals("en")){
                ...
                data.add(RecipesData(R.drawable.app_jaulo.toString(),"Jaulo", "Ingredients:\n" +
                        "Rice\t25 gram\n" +
